                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="services-one__top-right">
                                <p class="services-one__top-text">High accuracy diagnosis, consultation and diseases management powered by state of the art molecular lab and histopathology center.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="diagnostics.php">General Diagnostics</a></h2>
                                    <p class="service-one__text">Complete range of world class diagnostics services with fast turnaround time</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="histopathology.php">Histopathology Lab</a></h2>
                                    <p class="service-one__text">Advanced histopathology center clinical insights valuable for cricital diseases management.</p>
                                </div>
                            </div>
                        </div>
                        <!--Services One Single End-->
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="oncology.php">Oncology Solution</a></h2>
                                    <p class="service-one__text">Super speciality oncology services for comprehensive cancer diagnosis and management.</p>
                                </div>
                            </div>
                        </div>
                        <!--Services One Single End-->
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                            <div class="services-one__single">
                                ...
                                <div class="service-one__content">
                                    ...
                                    <h2 class="service-one__title"><a href="molecularlab.php">Molecular Lab</a>
                                    </h2>
                                    <p class="service-one__text">Providing high level of reliability and accuracy and are used to detect critical infectious diseases.</p>
                                </div>
                            </div>
                        </div>
                        <!--Services One Single End-->
                    ...
                    <div class="col-xl-7">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">World class cancer diagnosis &amp; management in Chattogram</h2>
                            </div>
                             <p class="about-one__text-2">Asperia healthcare ltd has introduced most advance cancer screening and management in Chattogram. Our oncology center provides comprehensive and super specialized, modern diagnostic services, treatment, and care for cancer.</p>
                                ...
                                <div class="services-three__img">
                                   <img src="admin/<?php echo $row["image"]?>" alt="">
                                    <div class="services-three__content">
                                        <h3 class="services-three__title"><a href="package-detail.php?id=<?php echo $row["id"]?>"><?php echo $row["category"]?></a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-lg-7 col-md-9 wow fadeInUp" data-wow-delay="700ms">
                            <div class="services-three__single">
                                <div class="services-three__get-quote">
                                    ...
                                    <h3 class="services-three__get-quote-title">Choose from more of our packages or get a customized corporate package ...</h3>
