...
If(!empty($_POST)){
	...
	$des = mysqli_real_escape_string($connection, $_POST["detail"]);
	$ord = mysqli_real_escape_string($connection, $_POST["ord"]);
	$status = mysqli_real_escape_string($connection, $_POST["status"]);
	$cat = mysqli_real_escape_string($connection, $_POST["dept"]);
 ...
 if(!empty($_FILES["img"]["name"])){
		...
		$query = "UPDATE product SET category='$cat', pname='$title',des='$des',image='$imagefile',ord='$ord', status='$status' WHERE id='$id'";
	} else {

		$query = "UPDATE product SET category='$cat', pname='$title',des='$des',ord='$ord', status='$status' WHERE id='$id'";
	}
